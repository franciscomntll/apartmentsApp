...
const InputField = ({label,...props}) => {
    ...
    return (
        ...
        <div className="relative ">
           <input id={field.name} className="peer w-full border-2 py-2 pl-2 border-gray-300 text-gray-900 placeholder-transparent focus:outline-none focus:border-gray-700 text-sm transition-colors rounded-md h-10 appearance-none	hover:appearance-nonefocus:appearance-none" placeholder="⠀" {...field} {...props}   />
